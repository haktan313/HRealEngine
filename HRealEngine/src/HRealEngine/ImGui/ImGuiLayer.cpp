...
namespace HRealEngine
{
	...
	{
		ImGui_ImplOpenGL3_NewFrame();//clear old draw data, ready to accept new vertices.
		ImGui_ImplGlfw_NewFrame();//Prepares the platform backend.
		ImGui::NewFrame();//start building a new UI frame.
	...
	void ImGuiLayer::End()
	{
		...
		ImGui::Render();//After this, ImGui is “done recording” — you can’t add new UI widgets.
		ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());

		if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)//This is the “docking / multiple windows” feature.
		{
